...
//        userRepository.addUser(user);
        ...
        assertEquals(userRepository.findAllForTest().get(3).getNameOne(), updateName.getNameOne());
        assertEquals(userRepository.findAllForTest().get(3).getNameTwo(), updateName.getNameTwo());
    }
